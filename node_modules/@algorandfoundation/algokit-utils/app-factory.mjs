...
var AppFactory = class {
	...
	*/
	...
	getDeployTimeControl(control) {
		...
		if (!approval || !approval.includes(control === "updatable" ? UPDATABLE_TEMPLATE_NAME : DELETABLE_TEMPLATE_NAME)) return void 0;
	...
	getParamsMethods() {
		return {
			...
			deployUpdate: (params) => {
				return this.getABIParams(params, OnApplicationComplete.UpdateApplication);
			},
			deployDelete: (params) => {
				return this.getABIParams(params, OnApplicationComplete.DeleteApplication);
			},
			bare: {
				create: async (params) => {
				...
				deployUpdate: (params) => {
					return this.getBareParams(params, OnApplicationComplete.UpdateApplication);
				},
				deployDelete: (params) => {
