...
import { AppDeployMetadata, OnSchemaBreak, OnUpdate, SendAppCreateTransactionResult, SendAppUpdateTransactionResult, TealTemplateParams } from "./app.js";
...
declare class AppDeployer {
   ...
   */
  getCreatorAppsByName(creator: ReadableAddress, ignoreCache?: boolean): Promise<AppLookup>;
}
//#endregion
