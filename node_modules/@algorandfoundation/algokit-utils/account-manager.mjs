...
var AccountManager = class {
	...
	*/
	setSigner(sender, signer) {
		this._accounts[getAddress(sender).toString()] = {
			addr: getAddress(sender),
			signer
		};
		return this;
	}
	...
	*/
	async dispenserFromEnvironment() {
		...
		return process.env[`${DISPENSER_ACCOUNT.toUpperCase()}_MNEMONIC`] ? await this.fromEnvironment(DISPENSER_ACCOUNT) : await this.localNetDispenser();
	}
	/**
