import { ABIType } from "./packages/abi/src/abi-type.mjs";

//#region src/app-spec.ts
/**
...
function arc32ToArc56(appSpec) {
	...
	const hint = (m) => appSpec.hints[getABIMethodParamsSignature(m)];
...
function getABIMethodParamsSignature(params) {
