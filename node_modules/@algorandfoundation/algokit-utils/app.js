...
const ABI_RETURN_PREFIX = new Uint8Array([
	21,
	31,
	124,
	117
...
let OnUpdate = /* @__PURE__ */ function(OnUpdate) {
	/** Fail the deployment */
...
let OnSchemaBreak = /* @__PURE__ */ function(OnSchemaBreak) {
	/** Fail the deployment */
...
exports.OnSchemaBreak = OnSchemaBreak;
