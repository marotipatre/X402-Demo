 ...
 */
declare function performTransactionComposerSimulate(composer: TransactionComposer, options?: RawSimulateOptions): Promise<SimulateResponse>;
//#endregion
export { performTransactionComposerSimulate };
//# sourceMappingURL=perform-transaction-composer-simulate.d.ts.map