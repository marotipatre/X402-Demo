...
import { StructField } from "./arc56-contract.js";

//#region packages/abi/src/abi-type.d.ts
 ...
 */
declare abstract class ABIType {
  /**
 ...
 */
declare class ABIUintType extends ABIType {
 ...
 */
declare class ABIUfixedType extends ABIType {
  readonly bitSize: number;
   ...
   */
  constructor(bitSize: number, precision: number);
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIAddressType extends ABIType {
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 * A boolean ABI type.
 */
declare class ABIBoolType extends ABIType {
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIByteType extends ABIType {
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIStringType extends ABIType {
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABITupleType extends ABIType {
  readonly childTypes: ABIType[];
  /**
   * Creates a new tuple type.
   * @param childTypes The types of the tuple elements
   */
  constructor(childTypes: ABIType[]);
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIArrayStaticType extends ABIType {
   ...
   */
  constructor(childType: ABIType, length: number);
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIArrayDynamicType extends ABIType {
  readonly childType: ABIType;
  /**
   * Creates a new dynamic array type.
   * @param childType The type of the array elements
   */
  constructor(childType: ABIType);
  get name(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
  byteLen(): number;
 ...
 */
declare class ABIStructType extends ABIType {
   ...
   */
  constructor(structName: string, structFields: ABIStructField[]);
  get name(): string;
  get displayName(): string;
  equals(other: ABIType): boolean;
  isDynamic(): boolean;
...
declare function parseTupleContent(content: string): string[];
//#endregion
export { ABIAddressType, ABIArrayDynamicType, ABIArrayStaticType, ABIBoolType, ABIByteType, ABIStringType, ABIStructField, ABIStructType, ABITupleType, ABIType, ABIUfixedType, ABIUintType, parseTupleContent };
//# sourceMappingURL=abi-type.d.ts.map