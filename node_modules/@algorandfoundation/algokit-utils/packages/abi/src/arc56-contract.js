...
function resolveStorageType(typeStr, structs) {
	...
	if (structs[typeStr]) return require_abi_type.ABIStructType.fromStruct(typeStr, structs);
	try {
		return require_abi_type.ABIType.from(typeStr);
	} catch (error) {
...
exports.getBoxABIStorageMap = getBoxABIStorageMap;
exports.getBoxABIStorageMaps = getBoxABIStorageMaps;
exports.getGlobalABIStorageKey = getGlobalABIStorageKey;
exports.getGlobalABIStorageKeys = getGlobalABIStorageKeys;
exports.getGlobalABIStorageMap = getGlobalABIStorageMap;
exports.getGlobalABIStorageMaps = getGlobalABIStorageMaps;
exports.getLocalABIStorageKey = getLocalABIStorageKey;
