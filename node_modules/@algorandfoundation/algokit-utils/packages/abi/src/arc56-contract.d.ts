 ...
 */
declare function getGlobalABIStorageKey(contract: Arc56Contract, keyName: string): ABIStorageKey;
/**
 ...
 * @throws Error if the key is not found
 */
declare function getLocalABIStorageKey(contract: Arc56Contract, keyName: string): ABIStorageKey;
/**
 ...
 * @throws Error if the key is not found
 */
declare function getBoxABIStorageKey(contract: Arc56Contract, keyName: string): ABIStorageKey;
/**
 * Get all global storage keys with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage key names to ABIStorageKey objects
 */
declare function getGlobalABIStorageKeys(contract: Arc56Contract): Record<string, ABIStorageKey>;
/**
 * Get all local storage keys with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage key names to ABIStorageKey objects
 */
declare function getLocalABIStorageKeys(contract: Arc56Contract): Record<string, ABIStorageKey>;
/**
 * Get all box storage keys with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage key names to ABIStorageKey objects
 */
declare function getBoxABIStorageKeys(contract: Arc56Contract): Record<string, ABIStorageKey>;
/**
 ...
 */
declare function getGlobalABIStorageMap(contract: Arc56Contract, mapName: string): ABIStorageMap;
/**
 ...
 * @throws Error if the map is not found
 */
declare function getLocalABIStorageMap(contract: Arc56Contract, mapName: string): ABIStorageMap;
/**
 ...
 * @throws Error if the map is not found
 */
declare function getBoxABIStorageMap(contract: Arc56Contract, mapName: string): ABIStorageMap;
/**
 * Get all global storage maps with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage map names to ABIStorageMap objects
 */
declare function getGlobalABIStorageMaps(contract: Arc56Contract): Record<string, ABIStorageMap>;
/**
 * Get all local storage maps with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage map names to ABIStorageMap objects
 */
declare function getLocalABIStorageMaps(contract: Arc56Contract): Record<string, ABIStorageMap>;
/**
 * Get all box storage maps with parsed ABI types
 * @param contract The ARC-56 contract
 * @returns A record of storage map names to ABIStorageMap objects
 */
declare function getBoxABIStorageMaps(contract: Arc56Contract): Record<string, ABIStorageMap>;
//#endregion
export { ABIStorageKey, ABIStorageMap, AVMBytes, AVMString, AVMType, AVMUint64, Arc56Contract, Arc56Method, Event, ProgramSourceInfo, StorageKey, StorageMap, StructField, StructName, getBoxABIStorageKey, getBoxABIStorageKeys, getBoxABIStorageMap, getBoxABIStorageMaps, getGlobalABIStorageKey, getGlobalABIStorageKeys, getGlobalABIStorageMap, getGlobalABIStorageMaps, getLocalABIStorageKey, getLocalABIStorageKeys, getLocalABIStorageMap, getLocalABIStorageMaps };
//# sourceMappingURL=arc56-contract.d.ts.map