...
function seedFromMnemonic(mnemonic) {
	...
	for (const w of key) if (english_default.indexOf(w) === -1) throw new Error(NOT_IN_WORDS_LIST_ERROR_MSG);
	const checksum = words[words.length - 1];
	let uint8Array = toUint8Array(key.map((word) => english_default.indexOf(word)));
