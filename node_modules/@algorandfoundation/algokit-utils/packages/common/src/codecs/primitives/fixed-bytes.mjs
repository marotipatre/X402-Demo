...
var FixedBytesCodec = class extends Codec {
	...
	toEncoded(value, format) {
		if (format === "json") return Buffer.from(value).toString("base64");
		return value;
	}
...
//#endregion
export { fixedBytes1793Codec, fixedBytes32Codec, fixedBytes64Codec };
//# sourceMappingURL=fixed-bytes.mjs.map