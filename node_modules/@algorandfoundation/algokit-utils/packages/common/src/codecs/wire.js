...
function normalizeWireString(value) {
	return value instanceof Uint8Array ? buffer.Buffer.from(value).toString("utf-8") : value;
}
...
//#endregion
exports.normalizeWireObject = normalizeWireObject;
exports.normalizeWireString = normalizeWireString;
